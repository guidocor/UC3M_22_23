...
m1 <- lm(error_e1~v1_e+a1_g+a2_e, data=df)
summary(m1) 
...
```{r}
plot(error_e1, df$v1_e, type="p", main = "Relación entre error y predicción", xlab = "Error", ylab = "Predicción")

cor(error_e1, df$v1_e)
```
